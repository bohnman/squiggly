...
public class DefaultConverters {
    ...
    public static void add(ConverterRecordRepository repo) {
        ...
        // Object
        repo.add(Object.class, String.class, SquigglyUtils::toString);
        repo.add(Object.class, Function.class, SquigglyUtils::toFunction);
        repo.add(Object.class, Predicate.class, SquigglyUtils::toPredicate);
        ...
        // TimeZone
        repo.add(String.class, TimeZone.class, Strings::toTimeZone);
