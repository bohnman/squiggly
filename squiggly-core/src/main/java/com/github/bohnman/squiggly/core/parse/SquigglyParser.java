...
import com.github.bohnman.squiggly.core.name.names.*;
import com.github.bohnman.squiggly.core.parse.antlr4.SquigglyGrammarBaseVisitor;
import com.github.bohnman.squiggly.core.parse.antlr4.SquigglyGrammarLexer;
import com.github.bohnman.squiggly.core.parse.antlr4.SquigglyGrammarParser;
import com.github.bohnman.squiggly.core.parse.nodes.*;
...
public class SquigglyParser {
    ...
    private class FilterVisitor extends SquigglyGrammarBaseVisitor<FilterNode> {
        ...
        private FunctionNode.Builder buildBaseFunction(SquigglyGrammarParser.FunctionContext functionContext, ParseContext context) {
