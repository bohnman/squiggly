...
import com.github.bohnman.squiggly.variable.SquigglyVariablesHolder;
...
/**
 * Servlet filter that sets the request on the {@link ServletRequestHolder}.
 */
@ThreadSafe
public class SquigglyRequestFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        ServletRequestHolder.setRequest(httpRequest);
        ...
        try {
            ...
            ServletRequestHolder.removeRequest();
